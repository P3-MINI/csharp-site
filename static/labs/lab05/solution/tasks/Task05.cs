...
namespace tasks;
public sealed class Task05 : IExecutable
{
    public void Execute(string[] args)
    {
        var movies = new List<Movie>(); // ciekawe kto seeda ogarnie :(
        var actors = new List<Actor>();
        var ratings = new List<Rating>();
        var casts = new List<Cast>();

        // Lista aktorów, którzy zagrali w filmach z gatunku Fantasy
        ...
        // Najdłuższy film w każdym gatunku
        ...
        // Filmy ze średnią oceną powyżej 8 i ich obsada
        ...
        // Aktorzy z liczbą zagraną ról (posortowani malejąco)
        ...
        // Filmy wydane w ostatnich 5 latach z ich średnią oceną, posortowane malejąco po ocenie
        ...
        // Aktorzy, którzy nigdy nie zagrali w thrillerze
        ...
        // Top 3 filmów z największą liczbą ocen
        ...
        // Filmy bez żadnej oceny (czyli brak ocen w systemie)
        ...
        // Najbardziej wszechstronni aktorzy (zagrali w największej liczbie różnych gatunków filmów)
...
public record Rating(int MovieId, int Score, DateTime CreatedAt);
