...
The starting code is available as a `P3A-25Z-Task2` repository on GitHub in the WUT-MiNI organization.

{{< tabs >}}
{{% tab "SSH" %}}
```bash
# Clone the repository:
git clone git@github.com:WUT-MiNI/P3A-25Z-Task2.git
...
```bash
# Clone the repository:
git clone https://github.com/WUT-MiNI/P3A-25Z-Task2.git
