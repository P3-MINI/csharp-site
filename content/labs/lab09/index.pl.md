...
Kod startowy dostępny jest w formie repozytorium `P3Z-25Z-Task4` na GitHubie w organizacji WUT-MiNI.

{{< tabs >}}
{{% tab "SSH" %}} 
```bash
# Clone the repository:
git clone git@github.com:WUT-MiNI/P3Z-25Z-Task4.git
...
```bash
# Clone the repository:
git clone https://github.com/WUT-MiNI/P3Z-25Z-Task4.git
